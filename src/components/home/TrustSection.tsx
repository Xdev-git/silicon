        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch justify-center md:justify-start gap-12 md:gap-16">
          ...
          <div className="flex-shrink-0 text-center md:text-left flex flex-col justify-center">
            <h2 className="leading-[1.1] tracking-tight">
              <span className="block text-[#020D2F] mb-1 tracking-widest uppercase drop-shadow-sm">Trust</span>
          ...
          {/* Separator */}
          <div className="hidden md:block w-px bg-zinc-300 self-stretch mx-4"></div>

          {/* Mobile Separator */}
          <div className="md:hidden h-px w-full max-w-xs bg-zinc-300"></div>

          {/* Right Column */}
          <div className="flex-1 max-w-3xl flex flex-col justify-center text-center md:text-left">
            <h3 className="text-black font-bold text-sm md:text-base uppercase tracking-wider mb-4">
              Premium real estate developers delivering homes over 30 years in India
            </h3>
            <p className="text-zinc-600 text-base md:text-md font-medium leading-tight mb-2">
              Built on the bedrock of <span className="text-black font-bold">30+ years of trust, innovation and knowledge-leadership</span>, the Silicon Group is one of India&apos;s leading Property Development, Management and Consulting organizations in India.
            </p>
