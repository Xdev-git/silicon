    ...
    <main className="min-h-screen bg-white pb-20 font-sans text-[#413F4C]">
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-xs font-bold uppercase tracking-widest text-[#BC9F81] mb-4">Resources</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <nav className="flex items-center text-sm text-[#413F4C]/60 font-medium mb-12">
          ...
          <span className="text-[#BC9F81] font-bold">Downloads</span>
        </nav>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {downloads.map((item, index) => (
            <div
              key={index}
              className="bg-[#F3EEEB] border border-[#413F4C]/10 p-6 flex items-start justify-between group hover:border-[#BC9F81]/40 transition-all hover:shadow-md hover:-translate-y-1"
            >
              <div className="flex-1">
                <h3 className="text-base font-bold mb-2 text-[#413F4C] group-hover:text-[#BC9F81] transition-colors">{item.name}</h3>
              ...
              <button className="w-10 h-10 rounded-full bg-white border border-[#413F4C]/10 flex items-center justify-center text-[#413F4C]/50 group-hover:bg-gradient-to-br group-hover:from-[#BC9F81] group-hover:to-[#AD9266] group-hover:text-[#413F4C] group-hover:border-[#BC9F81] transition-all duration-300 shadow-sm">
        ...
        <div className="mt-16 p-10 border border-[#BC9F81]/30 bg-[#F3EEEB] text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-[#BC9F81] mb-4">Support</p>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#BC9F81] to-[#AD9266] text-[#413F4C] px-8 py-4 font-bold uppercase tracking-widest transition-all duration-300 hover:shadow-xl hover:scale-[1.02]"
          >
            Contact Support
          </Link>
        </div>
