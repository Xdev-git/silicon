...
const steps = [
  {
    icon: <FileText className="w-8 h-8 text-[#BC9F81]" />,
  ...
  {
    icon: <BadgeCheck className="w-8 h-8 text-[#BC9F81]" />,
  ...
  {
    icon: <Scale className="w-8 h-8 text-[#BC9F81]" />,
    ...
    <main className="min-h-screen bg-white text-[#413F4C]">
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
          <nav className="flex justify-center items-center text-xs text-white/50 mb-6 font-semibold uppercase tracking-widest">
            ...
            <span className="text-[#BC9F81]">Buyer's Guide</span>
          </nav>
          <p className="text-xs font-bold uppercase tracking-widest text-[#BC9F81] mb-4">Your Journey</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-[#BC9F81] mb-4">Your Journey Starts Here</p>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#413F4C] mb-4">Making the <span className="text-[#BC9F81]">Right Choice</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, index) => (
              <div key={index} className="bg-white p-8 border border-[#413F4C]/10 hover:border-[#BC9F81]/50 transition-all duration-300 group hover:-translate-y-2 hover:shadow-xl">
                ...
                <h3 className="text-lg font-bold text-[#413F4C] mb-3 group-hover:text-[#BC9F81] transition-colors">{step.title}</h3>
      ...
      {/* Document Checklist */}
      <section className="py-32 bg-gradient-to-br from-[#BC9F81] to-[#AD9266] text-[#413F4C] relative overflow-hidden">
