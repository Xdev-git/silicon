...
export default function FirstStepsPage() {
  const steps = [
    {
      icon: <Calculator className="w-8 h-8 text-[#020D2F]" />,
    ...
    {
      icon: <Search className="w-8 h-8 text-[#020D2F]" />,
    ...
    {
      icon: <CheckCircle className="w-8 h-8 text-[#020D2F]" />,
    ...
    {
      icon: <FileSignature className="w-8 h-8 text-[#020D2F]" />,
    ...
    {
      icon: <Home className="w-8 h-8 text-[#020D2F]" />,
  ...
  return (
    <main className="min-h-screen bg-white text-[#413F4C]">
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto text-center">
        <p className="text-xs font-bold uppercase tracking-widest text-[#020D2F] mb-4">Step by Step</p>
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#413F4C] mb-4">
          Your Journey to <span className="text-[#020D2F]">Homeownership</span>
        </h2>
        ...
        <div className="max-w-7xl mx-auto py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-white border border-[#413F4C]/10 p-8 hover:border-[#020D2F]/50 hover:-translate-y-2 transition-all duration-300 group shadow-sm flex flex-col items-center text-center relative mt-6 lg:mt-0">
                {/* Step Number Badge */}
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#020D2F] to-[#413F4C] text-[#413F4C] font-bold text-sm w-8 h-8 rounded-full flex items-center justify-center z-20 shadow-md">
                  {index + 1}
                </div>
                ...
                <h3 className="text-lg font-bold text-[#413F4C] mb-3 group-hover:text-[#020D2F] transition-colors">
                  {step.title}
                </h3>
                <div className="w-6 h-[2px] bg-[#020D2F] mb-3"></div>
      ...
      <section className="py-24 px-6 md:px-12 bg-white text-center">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-[#020D2F] to-[#413F4C] p-12 border border-[#413F4C]/10 shadow-xl">
