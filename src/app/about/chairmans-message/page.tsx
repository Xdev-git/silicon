      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
          <nav className="flex justify-center items-center text-xs text-white/50 mb-6 font-semibold uppercase tracking-widest">
            ...
            <ChevronRight className="w-3.5 h-3.5 mx-2" />
            <span className="text-[#020D2F]">Chairman's Message</span>
          </nav>
          <p className="text-xs font-bold uppercase tracking-widest text-[#020D2F] mb-4">Leadership</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-5 relative sticky top-32">
              ...
              {/* Overlay Name Plate */}
              <div className="absolute -bottom-8 -right-8 md:-bottom-12 md:-right-12 bg-white p-8 md:p-10 shadow-2xl z-10 hidden sm:block border-l-4 border-[#020D2F]">
                ...
                <div className="w-12 h-[2px] bg-[#020D2F] mt-4"></div>
              </div>

              {/* Mobile Name Plate */}
              <div className="bg-white p-6 shadow-xl z-10 mt-[-2rem] relative mx-4 sm:hidden border-l-4 border-[#020D2F]">
            ...
            <div className="lg:col-span-7 pt-8 lg:pt-0">
              ...
              <Quote className="w-16 h-16 text-[#020D2F]/40 mb-8 -ml-4" />

              <p className="text-xl md:text-2xl font-bold leading-snug text-[#413F4C] mb-10 border-l-4 border-[#020D2F] pl-6">
              ...
              <div className="space-y-6 text-[#413F4C]/80 font-medium text-base md:text-lg leading-snug">
                ...
                <div className="pt-12 mt-12 border-t border-[#413F4C]/10 flex flex-col gap-2">
                  <div className="text-4xl text-[#020D2F]/60 font-serif italic mb-2 select-none opacity-80">
                    RK Sharma
                  </div>
                  <div className="text-xl text-[#020D2F] font-bold uppercase tracking-widest">
                    R.K. Sharma
                  </div>
                  <div className="text-xs uppercase tracking-[0.3em] text-[#413F4C]/60 font-bold">
                    Founder & Chairman
                  </div>
                </div>
              </div>
